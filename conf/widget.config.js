...
module.exports = {
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-gf@1.0.5/assets/Gantzert_Felixander.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
