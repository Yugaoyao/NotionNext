...
module.exports = {
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Yugaoyao',
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://bilibili.com/Yugaoyao',
